...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'One screen instead of five browser tabs. A retro LED clock, a binary clock, a month calendar, weather, email, Spotify, Guardian headlines, and live bus departures all on one glanceable dashboard for a phone or tablet propped up on a desk — no backend, installable as a PWA or a sideloaded Android APK.',
