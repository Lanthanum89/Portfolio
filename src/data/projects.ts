...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'Spotify Wrapped only happens once a year. I wanted my listening data all year round. A fully static, responsive web app showing top tracks, artists, genres, and recent history — installable on your phone, no backend required.',
    url: 'https://github.com/Lanthanum89/spotify-stats-app',
    languages: ['JavaScript', 'CSS', 'HTML'],
    tools: ['Spotify API', 'PWA'],
    categories: ['Tools & Apps'],
    pushedAt: '2026-07-21T22:05:14Z',
    featured: true,
    story: {
      ...
      challenge: 'Working within Spotify\'s API and auth flow without a server to hold a Client Secret, once I decided to actually host it instead of keeping it local-only.',
